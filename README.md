...
> specifications live in **[docs/](docs/README.md)**; the live state of play,
> including what is claimed and what is blocked, is
> **[docs/05-STATUS.md](docs/05-STATUS.md)**.
>
> Work proceeds **room by room and mechanic by mechanic**: one space is finished
> to a shippable standard before the next is started. See
> [docs/02-ROADMAP.md](docs/02-ROADMAP.md) for the phase order.
